...
assert.match(installer, /\$Version\s*=\s*'v0\.1\.8'/);
...
console.log("PASS installer contract: v0.1.8 pin, verified host, mandatory self Skill + MCP setup prompt, scoped uninstall");
