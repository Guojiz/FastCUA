...
assert.match(installer, /\$Version\s*=\s*'v0\.2\.0'/);
...
console.log("PASS installer contract: v0.2.0 pin, verified host, mandatory self Skill + MCP setup prompt, scoped uninstall");
