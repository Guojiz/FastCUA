...
assert.match(installer, /confirm that the installed computer-use Skill is active or discoverable/i);
...
console.log("PASS installer contract: v0.1.3 pin, verified host, mandatory self Skill + MCP install, scoped uninstall");
